...
const AttendanceDetail: React.FC<AttendanceDetailProps> = ({ attendance, account, onClose }) => {
  ...
  const renderContent = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 grid grid-cols-1 gap-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="p-4">
            <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2">Foto Verifikasi Pulang</p>
            <div className="aspect-video rounded-xl overflow-hidden border border-gray-100 bg-gray-50 flex items-center justify-center relative group">
  ...
  return (
    <DetailModulLayoutAdmin
      ...
      subtitle="Informasi lengkap kehadiran karyawan"
      account={account as any}
      date={attendance.created_at || new Date().toISOString()}
      onClose={onClose}
    >
      {renderContent()}
    </DetailModulLayoutAdmin>
